...
<body>
    ...
    <?php
        ...
        $sel = $conexion->query("SELECT * FROM examenes");
  ...
  <section>
    ...
    <li class="tooltip_content">
        <a href="adminExamenes.php"><span class="material-symbols-outlined">
        list
        </span></a>
        <span class="tooltip">Lista</span>
      </li>
      <li class="tooltip_content">
        <a href="adminExamenes_upload.php"><span class="material-symbols-outlined">
        add
        </span></a>
            ...
            <div class="col-md-12 bg-w">
              <table id="myTable" class="table table-striped table-light table-bordered">
                <thead class="table-dark">
                      ...
                      <th scope="col" class="text-center">Examenes</th>
                ...
                <tbody>
                      <?php foreach ($res as $val) { ?>
                          <tr>
                              ...
                              <td class="text-center">
                                <a href="edit.php?id=<?php echo $val['id_examenes']?>" class="btn btn-secondary">
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <h1 class="modal-title fs-5" id="staticBackdropLabel">Examen</h1>
    ...
    <script>
        ...
        $('#modalPdf').modal('show');
        $('#iframePDF').attr('src','<?php echo 'http://' . $_SERVER['HTTP_HOST'] . '/sisil7/examenes/'; ?>'+nombre);
        }
