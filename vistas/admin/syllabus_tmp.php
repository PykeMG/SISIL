...
<body>
    ...
    <?php
        ...
        $sel = $conexion->query("SELECT * FROM syllabus_tmp A inner join usuario B on A.id_usuario_up = B.id");
                ...
                <tbody class="table-group-divider">
                    <?php foreach ($res as $val) { ?>
                        <tr>
                            ...
                            echo $val['estado'] ?></td>
                            <td class="text-center"><?php echo $val['nombres']." ".$val['apellidos'] ?></td>
                            <td class="text-center"><?php echo $val['fch_subida'] ?></td>
                            <td class="text-center">
                                <button onclick="openModelPDF('<?php echo $val['nombre'] ?>')" class="btn btn-primary" type="button"><i class="fa-solid fa-eye"></i></button>
                                
                            </td>
                            <td class="text-center">
                                <a href="upload_syllabus.php?id=<?php echo $val['id_syllabus']?>" class="btn btn-secondary">
