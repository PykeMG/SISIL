...
<body>
    ...
    <div class="menu">
        ...
        <a href="examenes.php"><span class="material-symbols-outlined">
        list
        </span></a>
        <span class="tooltip">Lista</span>
      </li>
      <li class="tooltip_content">
        <a href="examenes_upload.php"><span class="material-symbols-outlined">
        add
        </span></a>
            ...
            <div class="form_up">
                <div class="bg-w">
                    <form  name="formulario" id="formulario" action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                                    <button type="submit" class="btn btn-primary py-3 col-12" name="btnregistrar" value="registro" name="registro">Subir Examen</button>
                            </div>
                    </form> 
                </div>
            </div>  
